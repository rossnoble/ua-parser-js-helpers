/**
 *
 * BrowserDetector.js v0.1
 * Wrapper around UAParser.js for convenient query methods
 * https://github.com/rossnoble/ua-parser-js-helpers
 * MIT License
 *
 */
...
var BrowserDetector = function (options) {
  ...
  var detectedUA = window && window.navigator && window.navigator.userAgent;

  this.ua = options.ua || detectedUA;
